        ...
        <>
            <div className="bg-white flex justify-center items-center w-1/2">
                ...
                <div className="md:w-4/5 sm:w-full">
                    ...
                    <small className="text-gray-400 block my-4 text-sm">No te preocupes, ingresa tu correo</small>
            ...
            <div className="w-1/2 h-screen bg-[url('/images/contraseña.jfif')] 
