...
export const ActualizarProfesores = ({ profesor, id, onClose }) => {
    ...
    useEffect(() => {
        if (profesor) {
            setProfesorId(profesor.id || profesor._id);
            setform({
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const url = `${import.meta.env.VITE_BACKEND_URL}/modificar-profesor/${profesorId}`;
